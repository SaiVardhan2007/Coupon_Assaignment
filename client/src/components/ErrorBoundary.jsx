...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-mentorify-cream flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full bg-mentorify-orange hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-200"
              >
                Refresh Page
              </button>
